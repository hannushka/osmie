...
public class EmbeddedCharacterIterator extends CharacterIterator{
     ...
     */
    public EmbeddedCharacterIterator(String textFilePath, Charset textFileEncoding, int miniBatchSize, int exampleLength, char[] validCharacters, int epochSize, boolean minimized) throws IOException {
        super(textFilePath, textFileEncoding, miniBatchSize, exampleLength, validCharacters, epochSize, minimized);
    }
