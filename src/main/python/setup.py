...
# Online sources
DK_WIKI_DUMP_URL = "https://dumps.wikimedia.org/dawiki/20180120/dawiki-20180120-pages-meta-current.xml.bz2"
DK_WIKI_DUMP = "dawiki-20180120-pages-meta-current.xml.bz2"
...
def generate_alphabet():
    alpha = {}
    with open(DK_KORPUS_FREQ_DICT, 'r') as f:       # Can easily be changed to streets or wiki dump!
        for line in f:
            for char in line:
                if char.isdigit():
                    continue
